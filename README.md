...
## 链接
- 博客：http://nimip.com   
- github：https://github.com/mayer2014/blog   
...
未开启路由：http://nimip.com/index.php/Home/Index/article/aid/60  
开启路由后：http://nimip.com/article/60
4. 把根目录下的robots.txt中的nimip.com改为自己的域名；
...
## 商业友好的开源协议
Nimip web遵循Apache2开源协议发布。Apache Licence是著名的非盈利开源组织Apache采用的协议。该协议和BSD类似，鼓励代码共享和尊重原作者的著作权，同样允许代码修改，再作为开源或商业软件发布。
